...
Lấy danh sách lịch sử các thông báo đã gửi trong hệ thống để theo dõi hoặc debug. Hỗ trợ lọc theo `receiverId` của người nhận.

- **URL:** `/api/notifications` hoặc `/api/notifications?receiverId=c3d4`
- **Method:** `GET`
